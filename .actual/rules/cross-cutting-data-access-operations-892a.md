...
- **R-30-001** MUST: Data access operations MUST be defined through declarative configuration objects that specify behavior parameters including retry policies, concurrency limits, and execution strategies.

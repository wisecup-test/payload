# Standardize Environment-Based Configuration Management Pattern: Configuration Values Externalized
...
- **R-CONFIG-001** MUST: Configuration values MUST be externalized from business logic into dedicated configuration modules or files.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. Violations detected by CI pipeline checks for hardcoded environment values result in pipeline failure and require code review approval before merge.
</enforcement>
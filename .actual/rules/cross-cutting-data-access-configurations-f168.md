...
- **R-30-006** SHOULD: Data access configurations SHOULD provide sensible defaults for retry counts, delays, and concurrency limits to simplify common use cases.

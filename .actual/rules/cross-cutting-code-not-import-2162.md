# Standardize Core Library Module Imports and Organization: Code Not Import
...
- **R-IMPORT-001** MUST_NOT: Code MUST NOT import from library internals or private APIs unless explicitly documented as stable.
...
<enforcement>
Claude Code MUST NOT skip or defer verification of import pattern compliance. All files in scope must be checked against R-IMPORT-001 before code is merged.
</enforcement>
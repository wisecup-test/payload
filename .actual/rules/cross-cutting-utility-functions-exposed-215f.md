# Adopt Utility Function Pattern for Public API Contracts: Utility Functions Exposed
...
- **R-UTIL-001** MUST: Utility functions exposed in public APIs MUST include TypeScript type definitions with explicit input and output types.
...
# Verify strict TypeScript compliance on utility modules
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All utility functions must pass strict TypeScript type checking and meet coverage thresholds before acceptance.
</enforcement>
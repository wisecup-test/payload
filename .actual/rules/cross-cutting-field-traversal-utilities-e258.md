...
- **R-30-001** MUST: Field traversal utilities MUST accept configuration objects that define traversal behavior, field selection criteria, and transformation rules.

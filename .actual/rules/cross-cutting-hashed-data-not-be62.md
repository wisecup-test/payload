# Adopt One-Way Hashing for Sensitive Data Protection: Hashed Data Not
...
- **R-HASH-001** MUST_NOT: Hashed data MUST NOT be reversible or decryptable - use encryption instead if data retrieval is required.

### Verify

```bash
# Check for approved hashing implementations
...
<enforcement>
Claude Code MUST NOT skip or defer verification of hashing implementations. All sensitive data handling must be reviewed against these rules before approval.
</enforcement>
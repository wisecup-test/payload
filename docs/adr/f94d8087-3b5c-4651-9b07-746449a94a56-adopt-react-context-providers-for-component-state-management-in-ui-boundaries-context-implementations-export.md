...
1. MUST: Context implementations MUST export both the Provider component and a custom hook for consuming the context

## Policy Block

- MUST Context implementations MUST export both the Provider component and a custom hook for consuming the context

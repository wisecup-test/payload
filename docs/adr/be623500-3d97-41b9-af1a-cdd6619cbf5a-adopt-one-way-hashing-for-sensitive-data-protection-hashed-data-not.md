...
1. MUST_NOT: Hashed data MUST NOT be reversible or decryptable - use encryption instead if data retrieval is required

## Policy Block

- MUST_NOT Hashed data MUST NOT be reversible or decryptable - use encryption instead if data retrieval is required

...
1. SHOULD: Provider-specific logic SHOULD be abstracted behind a common interface to facilitate adding new providers

## Policy Block

- SHOULD Provider-specific logic SHOULD be abstracted behind a common interface to facilitate adding new providers

...
1. MAY: Custom authentication strategies MAY integrate with MongoDB for user credential storage

## Policy Block

- MAY Custom authentication strategies MAY integrate with MongoDB for user credential storage

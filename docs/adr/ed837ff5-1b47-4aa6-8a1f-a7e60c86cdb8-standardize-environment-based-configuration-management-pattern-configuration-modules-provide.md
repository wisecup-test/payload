...
1. MAY: Configuration modules MAY provide default values with clear documentation of override mechanisms

## Policy Block

- MAY Configuration modules MAY provide default values with clear documentation of override mechanisms

...
1. MAY: Teams MAY use import aliases for commonly used library modules to improve code readability, provided aliases are documented

## Policy Block

- MAY Teams MAY use import aliases for commonly used library modules to improve code readability, provided aliases are documented

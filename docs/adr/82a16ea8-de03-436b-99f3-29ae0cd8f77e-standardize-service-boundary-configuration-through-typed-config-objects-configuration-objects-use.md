...
1. SHOULD: Configuration objects SHOULD use dependency injection patterns to declare external service dependencies rather than direct imports

## Policy Block

- SHOULD Configuration objects SHOULD use dependency injection patterns to declare external service dependencies rather than direct imports

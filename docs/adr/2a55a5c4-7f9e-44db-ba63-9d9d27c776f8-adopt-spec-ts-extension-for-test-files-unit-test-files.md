...
1. SHOULD: Unit test files SHOULD use the naming pattern matching the source file (e.g., traverseFields.spec.ts for traverseFields.ts)

## Policy Block

- SHOULD Unit test files SHOULD use the naming pattern matching the source file (e.g., traverseFields.spec.ts for traverseFields.ts)

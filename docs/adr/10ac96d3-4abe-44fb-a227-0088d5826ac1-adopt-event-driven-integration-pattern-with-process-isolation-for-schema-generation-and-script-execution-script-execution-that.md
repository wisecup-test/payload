...
1. MUST: All script execution that involves untrusted or dynamic code MUST be isolated in separate processes to prevent failures from affecting the main application

## Policy Block

- MUST All script execution that involves untrusted or dynamic code MUST be isolated in separate processes to prevent failures from affecting the main application

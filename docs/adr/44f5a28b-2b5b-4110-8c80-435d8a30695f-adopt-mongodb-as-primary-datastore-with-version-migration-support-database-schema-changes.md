...
1. MUST: Database schema changes MUST be implemented through versioned migration scripts

## Policy Block

- MUST Database schema changes MUST be implemented through versioned migration scripts

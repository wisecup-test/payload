...
1. MUST: Configuration objects defining service boundaries MUST be co-located with their service implementation or in a dedicated config module within the service directory

## Policy Block

- MUST Configuration objects defining service boundaries MUST be co-located with their service implementation or in a dedicated config module within the service directory

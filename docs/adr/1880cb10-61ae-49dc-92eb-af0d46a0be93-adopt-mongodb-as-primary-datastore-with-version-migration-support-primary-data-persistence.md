...
1. MUST: All primary data persistence operations MUST use MongoDB as the datastore

## Policy Block

- MUST All primary data persistence operations MUST use MongoDB as the datastore

...
1. MUST_NOT: Integer inputs MUST NOT be processed using loose equality (==) or implicit type conversion from strings

## Policy Block

- MUST_NOT Integer inputs MUST NOT be processed using loose equality (==) or implicit type conversion from strings

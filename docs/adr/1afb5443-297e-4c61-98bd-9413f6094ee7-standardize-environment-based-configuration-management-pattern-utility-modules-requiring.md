...
1. SHOULD: Utility modules requiring runtime configuration SHOULD expose configuration interfaces or accept configuration parameters

## Policy Block

- SHOULD Utility modules requiring runtime configuration SHOULD expose configuration interfaces or accept configuration parameters

...
1. SHOULD: Collections SHOULD use MongoDB's native document structure rather than attempting to emulate relational patterns

## Policy Block

- SHOULD Collections SHOULD use MongoDB's native document structure rather than attempting to emulate relational patterns

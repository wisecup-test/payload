...
1. MUST: After-change hooks and side effects MUST be triggered through message queue mechanisms rather than synchronous callbacks

## Policy Block

- MUST After-change hooks and side effects MUST be triggered through message queue mechanisms rather than synchronous callbacks

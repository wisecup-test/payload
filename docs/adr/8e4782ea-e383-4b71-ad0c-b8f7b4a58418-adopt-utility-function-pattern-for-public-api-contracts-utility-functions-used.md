...
1. SHOULD: Utility functions used across multiple packages SHOULD be placed in shared package locations to avoid duplication

## Policy Block

- SHOULD Utility functions used across multiple packages SHOULD be placed in shared package locations to avoid duplication

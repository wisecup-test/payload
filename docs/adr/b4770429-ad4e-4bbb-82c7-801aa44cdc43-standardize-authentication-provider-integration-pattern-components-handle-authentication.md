...
1. MUST: Components MUST handle authentication provider state consistently across edit interfaces and debugging tools

## Policy Block

- MUST Components MUST handle authentication provider state consistently across edit interfaces and debugging tools

...
1. SHOULD: Configuration objects SHOULD be validated at initialization time to catch configuration errors before runtime execution

## Policy Block

- SHOULD Configuration objects SHOULD be validated at initialization time to catch configuration errors before runtime execution

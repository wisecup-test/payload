...
1. MUST: All asynchronous functions MUST be declared using the async keyword and return Promises

## Policy Block

- MUST All asynchronous functions MUST be declared using the async keyword and return Promises

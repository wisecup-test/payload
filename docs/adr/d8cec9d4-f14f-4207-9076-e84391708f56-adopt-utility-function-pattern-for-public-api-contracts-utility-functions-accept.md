...
1. MAY: Utility functions MAY accept optional configuration objects to support extensibility without breaking existing API contracts

## Policy Block

- MAY Utility functions MAY accept optional configuration objects to support extensibility without breaking existing API contracts

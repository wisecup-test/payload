...
1. MUST: All test files MUST use the .spec.ts extension for TypeScript test files

## Policy Block

- MUST All test files MUST use the .spec.ts extension for TypeScript test files

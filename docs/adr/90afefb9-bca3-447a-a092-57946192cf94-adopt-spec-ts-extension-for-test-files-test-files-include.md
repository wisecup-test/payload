...
1. MAY: Test files MAY include additional descriptive segments in the filename before the type indicator (e.g., forgot-password-localized/int.spec.ts)

## Policy Block

- MAY Test files MAY include additional descriptive segments in the filename before the type indicator (e.g., forgot-password-localized/int.spec.ts)

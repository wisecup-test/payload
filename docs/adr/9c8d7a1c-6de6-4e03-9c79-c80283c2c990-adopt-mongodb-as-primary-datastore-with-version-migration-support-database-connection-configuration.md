...
1. MUST: Database connection configuration MUST be centralized and environment-aware

## Policy Block

- MUST Database connection configuration MUST be centralized and environment-aware

...
1. MUST: Asynchronous operations MUST be invoked using the await keyword within async contexts

## Policy Block

- MUST Asynchronous operations MUST be invoked using the await keyword within async contexts

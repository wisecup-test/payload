...
1. MUST_NOT: Code MUST NOT import from library internals or private APIs unless explicitly documented as stable

## Policy Block

- MUST_NOT Code MUST NOT import from library internals or private APIs unless explicitly documented as stable

...
1. SHOULD: Generated schemas SHOULD be cached or memoized when the same payload structure is processed multiple times

## Policy Block

- SHOULD Generated schemas SHOULD be cached or memoized when the same payload structure is processed multiple times

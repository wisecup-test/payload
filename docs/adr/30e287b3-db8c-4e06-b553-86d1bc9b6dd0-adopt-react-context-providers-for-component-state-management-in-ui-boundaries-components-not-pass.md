...
1. MUST_NOT: Components MUST NOT pass state through multiple layers of props when a Context Provider boundary would be more appropriate

## Policy Block

- MUST_NOT Components MUST NOT pass state through multiple layers of props when a Context Provider boundary would be more appropriate

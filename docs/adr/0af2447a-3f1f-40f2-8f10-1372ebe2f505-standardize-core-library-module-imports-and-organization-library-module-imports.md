...
1. SHOULD: Library module imports SHOULD be grouped by source (external libraries, internal packages, relative imports) with blank lines separating groups

## Policy Block

- SHOULD Library module imports SHOULD be grouped by source (external libraries, internal packages, relative imports) with blank lines separating groups

...
1. MUST: Public utility functions MUST be accompanied by unit tests covering normal cases, edge cases, and error conditions

## Policy Block

- MUST Public utility functions MUST be accompanied by unit tests covering normal cases, edge cases, and error conditions

...
1. MUST: Test suites MUST consume configuration from centralized configuration sources rather than hardcoding values

## Policy Block

- MUST Test suites MUST consume configuration from centralized configuration sources rather than hardcoding values

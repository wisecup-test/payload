...
1. SHOULD: Context state SHOULD be scoped to the smallest component subtree that requires access to avoid unnecessary re-renders

## Policy Block

- SHOULD Context state SHOULD be scoped to the smallest component subtree that requires access to avoid unnecessary re-renders

...
1. MAY: Components MAY implement local event queues for managing internal state transitions before publishing to shared message queues

## Policy Block

- MAY Components MAY implement local event queues for managing internal state transitions before publishing to shared message queues

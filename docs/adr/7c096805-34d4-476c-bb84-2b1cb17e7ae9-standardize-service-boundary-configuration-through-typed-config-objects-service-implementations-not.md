...
1. MUST_NOT: Service implementations MUST NOT access configuration values outside their declared boundary configuration object

## Policy Block

- MUST_NOT Service implementations MUST NOT access configuration values outside their declared boundary configuration object

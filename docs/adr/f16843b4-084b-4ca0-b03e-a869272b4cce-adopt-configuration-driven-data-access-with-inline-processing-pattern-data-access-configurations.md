# Adopt Configuration-Driven Data Access with Inline Processing Pattern: Data Access Configurations
...
1. SHOULD: Data access configurations SHOULD provide sensible defaults for retry counts, delays, and concurrency limits to simplify common use cases

## Policy Block

- SHOULD Data access configurations SHOULD provide sensible defaults for retry counts, delays, and concurrency limits to simplify common use cases

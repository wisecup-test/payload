...
1. SHOULD: Message queue patterns SHOULD be used for cross-package communication between ui and plugin layers

## Policy Block

- SHOULD Message queue patterns SHOULD be used for cross-package communication between ui and plugin layers

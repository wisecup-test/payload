...
1. MAY: Components MAY implement additional data protection measures such as truncation, masking, or tokenization in combination with hashing

## Policy Block

- MAY Components MAY implement additional data protection measures such as truncation, masking, or tokenization in combination with hashing

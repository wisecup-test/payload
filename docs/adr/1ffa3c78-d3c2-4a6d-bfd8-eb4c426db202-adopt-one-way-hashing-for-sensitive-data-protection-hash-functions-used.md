...
1. MUST: Hash functions used MUST be cryptographically secure (e.g., SHA-256, SHA-512, bcrypt, Argon2) and MUST NOT use deprecated algorithms like MD5 or SHA-1

## Policy Block

- MUST Hash functions used MUST be cryptographically secure (e.g., SHA-256, SHA-512, bcrypt, Argon2) and MUST NOT use deprecated algorithms like MD5 or SHA-1

# Adopt Configuration-Driven Data Access with Inline Processing Pattern: Data Access Operations
...
1. MUST: Data access operations MUST be defined through declarative configuration objects that specify behavior parameters including retry policies, concurrency limits, and execution strategies

## Policy Block

- MUST Data access operations MUST be defined through declarative configuration objects that specify behavior parameters including retry policies, concurrency limits, and execution strategies

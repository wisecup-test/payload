...
1. MAY: Services MAY provide multiple configuration presets for different deployment environments or use cases

## Policy Block

- MAY Services MAY provide multiple configuration presets for different deployment environments or use cases

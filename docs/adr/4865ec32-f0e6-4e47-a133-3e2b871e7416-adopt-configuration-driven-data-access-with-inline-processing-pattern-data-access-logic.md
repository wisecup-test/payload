...
1. MUST_NOT: Data access logic MUST NOT hard-code retry policies, concurrency limits, or execution strategies that should be configurable

## Policy Block

- MUST_NOT Data access logic MUST NOT hard-code retry policies, concurrency limits, or execution strategies that should be configurable

...
1. MUST: Migration scripts MUST support both 'up' and 'down' operations for rollback capability

## Policy Block

- MUST Migration scripts MUST support both 'up' and 'down' operations for rollback capability

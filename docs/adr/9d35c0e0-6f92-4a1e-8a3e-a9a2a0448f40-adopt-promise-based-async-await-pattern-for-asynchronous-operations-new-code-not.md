...
1. MUST_NOT: New code MUST NOT use callback-based patterns for asynchronous operations except when interfacing with legacy APIs

## Policy Block

- MUST_NOT New code MUST NOT use callback-based patterns for asynchronous operations except when interfacing with legacy APIs

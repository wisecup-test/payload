...
1. SHOULD: Developers SHOULD use named imports rather than namespace imports where possible to enable better tree-shaking

## Policy Block

- SHOULD Developers SHOULD use named imports rather than namespace imports where possible to enable better tree-shaking

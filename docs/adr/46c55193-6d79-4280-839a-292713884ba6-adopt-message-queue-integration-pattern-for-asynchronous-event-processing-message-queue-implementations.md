...
1. SHOULD: Message queue implementations SHOULD support event ordering guarantees for operations that require sequential processing (e.g., drag-and-drop reordering)

## Policy Block

- SHOULD Message queue implementations SHOULD support event ordering guarantees for operations that require sequential processing (e.g., drag-and-drop reordering)

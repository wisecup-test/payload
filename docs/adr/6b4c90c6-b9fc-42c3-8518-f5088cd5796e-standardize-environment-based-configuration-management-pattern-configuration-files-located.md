...
1. SHOULD: Configuration files SHOULD be co-located with the modules they configure (e.g., test/auth/config.ts for authentication tests)

## Policy Block

- SHOULD Configuration files SHOULD be co-located with the modules they configure (e.g., test/auth/config.ts for authentication tests)

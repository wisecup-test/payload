...
1. MUST: Configuration values MUST be externalized from business logic into dedicated configuration modules or files

## Policy Block

- MUST Configuration values MUST be externalized from business logic into dedicated configuration modules or files

...
1. MAY: Context Providers MAY compose multiple contexts when managing orthogonal concerns within the same component boundary

## Policy Block

- MAY Context Providers MAY compose multiple contexts when managing orthogonal concerns within the same component boundary

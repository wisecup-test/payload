...
1. MAY: Integration components MAY use message queues or event buses for asynchronous communication when immediate responses are not required

## Policy Block

- MAY Integration components MAY use message queues or event buses for asynchronous communication when immediate responses are not required

...
1. MUST: Integration points between UI components and backend services MUST implement message-based communication to prevent blocking operations

## Policy Block

- MUST Integration points between UI components and backend services MUST implement message-based communication to prevent blocking operations

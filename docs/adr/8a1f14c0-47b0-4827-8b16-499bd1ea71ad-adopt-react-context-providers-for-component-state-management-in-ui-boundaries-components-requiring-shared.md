...
1. MUST: UI components requiring shared state across multiple child components MUST use React Context Providers to establish middleware boundaries

## Policy Block

- MUST UI components requiring shared state across multiple child components MUST use React Context Providers to establish middleware boundaries

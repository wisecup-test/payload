...
1. SHOULD: Test files SHOULD be co-located with the code they test or organized in a dedicated test/ directory structure

## Policy Block

- SHOULD Test files SHOULD be co-located with the code they test or organized in a dedicated test/ directory structure

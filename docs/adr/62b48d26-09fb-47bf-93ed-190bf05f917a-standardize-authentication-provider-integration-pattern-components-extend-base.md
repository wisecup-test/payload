...
1. MAY: Components MAY extend the base authentication provider pattern with component-specific functionality when necessary

## Policy Block

- MAY Components MAY extend the base authentication provider pattern with component-specific functionality when necessary
